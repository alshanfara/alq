...
$(`<div class="youtubeSearch" style="position: relative;float: right;width: 100%;top: 0;"> 
      ...
      <div style="display: flex;background-color: white;padding: 2px 0;border-bottom: 1px solid;"> 
       ...
       <input style="text-align: center;float: right;" type="text" class="form-control youtubeVal" placeholder=" شات سهر الشام / قريبا"> 
      ...
      <div style="display: none;" class="vieYoutube"> 
       ...
       <button style="margin: 0 2px;width: 48%;margin-top: -28px;text-align: center;" class="youtubeSend fa fa-send  fr btn btn-primary">ط§ط±ط³ط§ظ„ ط§ظ„ظ‰ ط§ظ„ط­ط§ط¦ط·</button> 
       <button onclick="$('.vieYoutube').hide();" style="margin: 0 2px;width: 48%;margin-top: -28px;text-align: center;" class="youtubeCloos fa fl btn btn-primary">ط§ظ„ط؛ط§ط،</button> 
      </div> 
     </div> 
